...
\subsection{Participant Enrollment}
	...
	"The development of IoT technologies and social network services (SNS) are contributing
	to the growth of big data. However, the vast amount of data makes it difficult for users to
	find the information they need, and as a result, the demand for a system that provides the
	desired information in a well-organized form is increasing. \cite{Hyun2022}"
