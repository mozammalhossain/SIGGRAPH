...
\subsection{Participant Enrollment}
	...
	"We conducted fve focus groups and one interview with a total of 14 participants from September to November 2023 via Zoom. \cite{10.1145/3613905.3650862} Participants were recruited via Amazon MTurk, a university email list, social media (e.g., Instagram and Facebook), and authors’ personal networks. The participant pool was diverse in terms of age, gender, education, and occupation (see table 1).
	The focus groups were centered around fve major probes: A majority of participants (93\%) answered that they frst turn to Google Search Engine
