...
\subsection{Literacy Level}
	...
	OECD Literacy Proficiency \cite{OECD}
...
\subsection{VFS Images}\label{vfsLegeds}
	\enquote{A picture is worth a thousand words} \cite{sullivan_picture_2017}. Visual representations of complex agreements not only clarify the content but can also improve decision making for non-technical users \cite{suters_emergence_2023, kim_impact_2021}. Although many companies rely on visual materials to simplify product instructions, it is uncommon to apply the same approach when verifying a user’s understanding of software license agreements, even though visual formats may enhance information quality, credibility, and decision making \cite{kim_impact_2021}. This research anticipated that a VFS will serve as an effective method for conveying license related information in a pictorial form. Although this research introduced four types of VFS users with definitions, it concentrated only on the end-user type. All images used in this research for preparing the VFS were publicly available in generic form and downloaded from Flaticon.com.
...
\section{Participant Enrollment, Sampling and Distribution Technology}
